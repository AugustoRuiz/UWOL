			                  ...
			                  int tilesY)
{
	...
	this->_texture = new Frame("data/Entrelazado.png");
	this->_texture2 = new Frame("data/Entrelazado2.png");
	this->_tv1 = new Frame("data/tvSim1.png");
	this->_tv2 = new Frame("data/tvSim2.png");
	this->_tv3 = new Frame("data/tvSim3.png");
