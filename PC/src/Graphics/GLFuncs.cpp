...
SDL_Surface *GLFuncs::Initialize(int screenWidth, int screenHeight, GLboolean fullscreen)
{
	SDL_Surface *screen;
	Uint32 flags;
...
//	flags = SDL_OPENGL | SDL_DOUBLEBUF | SDL_HWSURFACE; //| SDL_ASYNCBLIT; // | SDL_RESIZABLE
	flags = SDL_OPENGL;
