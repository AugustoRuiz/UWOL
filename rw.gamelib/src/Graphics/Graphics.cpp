...
void Graphics::BlitColoredFrameAbs(Frame* frame, int x, int y, int width, int height,
	...
	tx1 = flipX ? frame->Coords.tx2 : frame->Coords.tx1;
	ty1 = flipY ? frame->Coords.ty2 : frame->Coords.ty1;
...
void Graphics::BlitFrameAbs(Frame* frame, int x, int y, int width, int height, bool flipX, bool flipY)
{
	this->BlitColoredFrameAbs(frame, x, y, width, height, 1.0f, 1.0f, 1.0f, 1.0f, false, flipX, flipY);
}

void Graphics::BlitFrameAlphaAbs(Frame* frame, int x, int y, int width, int height, float alpha, bool flipX, bool flipY)
{
...
void Graphics::BlitShadowAbs(Frame* frame, int x, int y, int width, int height, bool flipX, bool flipY)
{
	this->BlitColoredFrameAbs(frame,
		x, y,
		width, height,
...
void Graphics::BlitColoredFrame(Frame* frame, int x, int y, int width, int height,
	float red, float green, float blue, float alpha, bool additive, bool flipX, bool flipY) {
	this->BlitColoredFrameAbs(frame,
...
void Graphics::BlitFrame(Frame* frame, int x, int y, int width, int height, bool flipX, bool flipY)
{
	this->BlitColoredFrameAbs(frame,
		(int)(x + this->OffsetX), (int)(y + this->OffsetY),
		width, height,
...
void Graphics::BlitFrameAlpha(Frame* frame, int x, int y, int width, int height, float alpha, bool flipX, bool flipY)
{
	this->BlitColoredFrameAbs(frame,
		(int)(x + this->OffsetX), (int)(y + this->OffsetY),
		width, height,
...
void Graphics::BlitCenteredFrameAlpha(Frame* frame, int width, int height, float alpha, bool flipX, bool flipY)
{
...
void Graphics::BlitShadow(Frame* frame, int x, int y, int width, int height, bool flipX, bool flipY)
{
	int x1, x2, y1, y2;
